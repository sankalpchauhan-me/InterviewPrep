...
public class LongestPalindromicSubstring {
	 ...
	 * are 4 cases to handle Case 1 : Right side palindrome is totally contained
	 * under current palindrome. In this case do not consider this as center. Case 2
	 * : Current palindrome is proper suffix of input. Terminate the loop in this
	 * case. No better palindrom will be found on right. Case 3 : Right side
	 * palindrome is proper suffix and its corresponding left side palindrome is
