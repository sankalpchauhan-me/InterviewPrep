...
// A variation of BFS that can be applied to weighted edges graph,
// whereas BFS works to find shortest path for unweighted edges/ edges with same weight
//O(ElogV)
public class DijkstraAlgo {
	...
	public static void shortestPath(Graph graph, int source, int N) {
		...
		for (int i = 1; i < N; ++i) {
			System.out.print("Path from vertex 0 to vertex " + i + " has minimum cost of " + dist.get(i)
					+ " and the route is [ ");
			printRoute(prev, i);
			System.out.println("]");
		}
