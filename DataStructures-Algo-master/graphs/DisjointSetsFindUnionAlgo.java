...
public class DisjointSetsFindUnionAlgo {
	...
	public static void printSets(int[] universe, DisjointSetsFindUnionAlgo ds) {
		for (int i : universe)
	...
	public static void main(String[] args) {
		...
		DisjointSetsFindUnionAlgo ds = new DisjointSetsFindUnionAlgo();
